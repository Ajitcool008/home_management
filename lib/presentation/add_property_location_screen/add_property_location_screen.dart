...
class AddPropertyLocationScreen extends StatefulWidget {
  const AddPropertyLocationScreen({super.key});

  @override
  State<AddPropertyLocationScreen> createState() => _AddPropertyLocationScreenState();
}

class _AddPropertyLocationScreenState extends State<AddPropertyLocationScreen> {
  AddPropertyLocationController addPropertyLocationController = Get.put(AddPropertyLocationController());
            ...
            child: Column(children: [
              ...
              Expanded(child: ListView(
                ...
                children: [
                  ...
                  phoneNumberField(addPropertyLocationController.phoneNumberController,
                          (p0) {
  ...
  Widget _buildAddress() {
    return CustomTextFormField(
        controller: addPropertyLocationController.addressController,
  ...
  Widget _buildAddress1() {
    return CustomTextFormField(
        controller: addPropertyLocationController.addressController1,
        hintText: "Enter Address",     enableBorder: false,
    );
  }
  ...
  /// Displays a dialog with the [PropertyAddSuccess1Dialog] content.
  onTapSubmit() {

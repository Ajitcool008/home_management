...
import 'package:home_management/presentation/property_details_one_screen/models/property_details_one_model.dart';
...
class PropertyDetailsOneScreen extends StatefulWidget {
  ...
  @override
  State<PropertyDetailsOneScreen> createState() => _PropertyDetailsOneScreenState();
}
...
onTapTxtViewAll() {
  ...
  Get.bottomSheet(
    isDismissible: false,
      FacilitiesViewAll(), isScrollControlled: true);
}

...
import 'package:home_management/widgets/custom_outlined_button.dart';
...
class LogOutDialog extends StatelessWidget {
  ...
  onTapLogOut() {
    ...
    SharedPreferencesClass setHome =
    SharedPreferencesClass();
    setHome.setData(false, true);

    HomeScreenContainerController homeScreenContainerController = Get.find<HomeScreenContainerController>();

...
class _HobbiesScreenState extends State<HobbiesScreen> {
  ...
  Widget _buildFrame1() {
    return Wrap(
        runSpacing: 16.v,
        spacing: 16.h,
        children:   List<Widget>.generate(listFrame1ItemModelDetail.length, (index) {
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: ShapeDecoration(
                color:listFrame1ItemModelDetail[index].isSelectCreative == true? Color(0xFfFFD65C) :Colors.white,
              ...
              child: Row(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      color:listFrame1ItemModelDetail[index].isSelectCreative == true? appTheme.gray900:appTheme.gray800,
                      fontSize: 16.fSize,
        ...
        children:List<Widget>.generate(listFrame1ItemModelDetail.length, (index) {
          return GestureDetector(
            ...
            child: Container(
              ...
              padding: EdgeInsets.symmetric(horizontal: 12.h, vertical: 8.v),
              decoration: ShapeDecoration(
                color:listFrame3ItemModelDetail[index].isSelectActivity == true? Color(0xFfFFD65C) :Colors.white,
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(6.h)),
              ),
              child: Row(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      color:listFrame3ItemModelDetail[index].isSelectActivity == true? appTheme.gray900:appTheme.gray800,
                      fontSize: 16.fSize,
                      fontFamily: 'Neutrif Pro',
                      fontWeight: FontWeight.w400,
                    ),

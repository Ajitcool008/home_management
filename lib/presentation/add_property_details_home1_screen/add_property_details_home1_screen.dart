...
import 'package:home_management/presentation/property_add_success_dialog/property_add_success_dialog.dart';
import 'package:home_management/presentation/property_add_success_dialog/controller/property_add_success_controller.dart';
...
class AddPropertyDetailsHome1Screen extends StatefulWidget {
  ...
  @override
  State<AddPropertyDetailsHome1Screen> createState() => _AddPropertyDetailsHome1ScreenState();
}

class _AddPropertyDetailsHome1ScreenState extends State<AddPropertyDetailsHome1Screen> {
  AddPropertyDetailsHome1Controller addPropertyDetailsHome1Controller = Get.put(AddPropertyDetailsHome1Controller());
                  ...
                  child: ListView(
                    ...
                    primary: true,shrinkWrap: false,
                      children: [
                        ...
                        SizedBox(height: 5.v),
                        phoneNumberField(addPropertyDetailsHome1Controller.phoneNumberController,

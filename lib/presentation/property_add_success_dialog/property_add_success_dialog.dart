import 'controller/property_add_success_controller.dart';
...
class PropertyAddSuccessDialog extends StatelessWidget {
  PropertyAddSuccessDialog(this.controller, {Key? key}) : super(key: key);

  PropertyAddSuccessController controller;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text("msg_you_have_successfully4".tr,
              maxLines: 2,

...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  List<String> city = ["Broome", "surat","rajkot","ahmedabad","vadodara","gandhinagar"];
  ...
  List<String> country = ["USA", "India","UK","Australia","Canada","China","Japan","Russia","France","Germany"];
              ...
              child: ListView(
                ...
                children: [
                  Column(children: [
                    ...
                    SizedBox(height: 5.v),
                    phoneNumberField(addNewAddressController.phoneNumberController,

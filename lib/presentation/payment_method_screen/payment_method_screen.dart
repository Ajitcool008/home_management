...
import 'package:home_management/presentation/payment_success_dialog/payment_success_dialog.dart';
import 'package:home_management/presentation/payment_success_dialog/controller/payment_success_controller.dart';
  ...
  Widget _buildPaymentDetailsRow1() {
    return Obx(
      () =>
       GestureDetector(
        onTap: () {
          paymentMethodController.isPaypal.value = !paymentMethodController.isPaypal.value;
  ...
  Widget _buildPaymentDetailsRow2() {
    return Obx(
      () =>
       GestureDetector(
        onTap: () {
          paymentMethodController.isVisa.value = !paymentMethodController.isVisa.value;
        ...
        child: Container(
            ...
            child:
              ...
              Row(
                children: [
                  CustomImageView(
                      imagePath: ImageConstant.imgRemixiconsLineLogosVisaline,
                      height: 34.adaptSize,
                      width: 34.adaptSize),
                  SizedBox(
                    width: 16.h,
  ...
  Widget _buildPaymentDetailsRow3() {
    return Obx(
      () =>
       GestureDetector(
        onTap: () {
          paymentMethodController.isApplePay.value = !paymentMethodController.isApplePay.value;
          paymentMethodController.isPaypal.value = false;
          paymentMethodController.isVisa.value = false;
          paymentMethodController.isGooglePay.value = false;
        },
  ...
  Widget _buildPaymentDetailsRow4() {
    return Obx(
      () =>
       GestureDetector(
        onTap: () {
          paymentMethodController.isGooglePay.value = !paymentMethodController.isGooglePay.value;
          paymentMethodController.isPaypal.value = false;
          paymentMethodController.isVisa.value = false;
          paymentMethodController.isApplePay.value = false;
        },
  ...
  Widget _buildOrderSummary() {
    return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(height: 16.v),
          Divider(color: appTheme.black20,),
          SizedBox(height: 16.v),
          _buildTax(

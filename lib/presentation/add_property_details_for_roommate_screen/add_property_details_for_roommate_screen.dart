...
class _AddPropertyDetailsForRoommateScreenState
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    Align(
                        alignment: Alignment.centerLeft,
                        child: Text("lbl_suitable_for".tr,
                            style: theme.textTheme.titleMedium)),
                    SizedBox(height: 16.v),
                    _buildStudents(),
                    SizedBox(height: 16.v),
  ...
  Widget _buildFieldlable() {
    return CustomTextFormField(
        controller:
            addPropertyDetailsForRoommateController.fieldLableController,
    ...
    return Expanded(
        child: Padding(
            ...
            child: CustomTextFormField(
                controller: addPropertyDetailsForRoommateController.bedController,
  ...
  Widget _buildBaths() {
    return Expanded(
        child: Padding(
            padding: EdgeInsets.only(left: 8.h),
            child: CustomTextFormField(
                controller: addPropertyDetailsForRoommateController.bathsController,
  ...
  Widget _buildSQFT() {
    return Expanded(
        child: Padding(
            padding: EdgeInsets.only(left: 8.h),
            child: CustomTextFormField(
                controller: addPropertyDetailsForRoommateController.sQFTController,
                ...
                Row(
                  ...
                  children: [
                    Obx(
                          ...
                          child: addPropertyDetailsForRoommateController.wifi.value ==
                              true
                              ? CustomImageView(
                            imagePath:
                ...
                Row(
                  ...
                  children: [
                    Obx(
                          () => GestureDetector(
                          onTap: () {
                            addPropertyDetailsForRoommateController.elevator.value =
                            !addPropertyDetailsForRoommateController
                                .elevator.value;
                          },
                          child:
                ...
                Row(
                  ...
                  children: [
                    Obx(
                          () => GestureDetector(
                          onTap: () {
                            addPropertyDetailsForRoommateController.furniture.value =
                            !addPropertyDetailsForRoommateController
                                .furniture.value;
                          },
                  ...
                  Row(
                    ...
                    children: [
                      Obx(
                            () => GestureDetector(
                            onTap: () {
                              addPropertyDetailsForRoommateController.generator.value =
                              !addPropertyDetailsForRoommateController
                                  .generator.value;
                            },
                            child: addPropertyDetailsForRoommateController
                ...
                Row(
                  ...
                  children: [
                    Obx(
                          () => GestureDetector(
                          onTap: () {
                            addPropertyDetailsForRoommateController.students.value =
                            !addPropertyDetailsForRoommateController.students.value;
                          },
                          child: addPropertyDetailsForRoommateController.students.value ==
                              true
                              ? CustomImageView(
                            imagePath:
                            "assets/images/check box theme.svg",
                ...
                Row(
                  ...
                  children: [
                    Obx(
                          () => GestureDetector(
                          onTap: () {
                            addPropertyDetailsForRoommateController.petLover.value =
                            !addPropertyDetailsForRoommateController
                                .petLover.value;
                          },
                          child: addPropertyDetailsForRoommateController
                  ...
                  Row(
                    ...
                    children: [
                      Obx(
                            () => GestureDetector(
                            onTap: () {
                              addPropertyDetailsForRoommateController.vegetarian.value =
                              !addPropertyDetailsForRoommateController
                                  .vegetarian.value;
                            },
                            child: addPropertyDetailsForRoommateController
